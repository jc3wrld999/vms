...
public class BusApiController {
    ...
    public ResponseEntity<?> getRoutePathByRouteId(@PathVariable(value="routeId") int routeId) {
        return busBoardService.getRoutePathByRouteId(routeId);
    }

    /** 버스번호 조회 */
    @GetMapping("/getRouteIdByRouteNm/{routeNm}")
    public ResponseEntity<?> getRouteIdByRouteNm(@PathVariable(value="routeNm") int routeNm) {
